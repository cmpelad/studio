...
// --- Helper function to fetch and parse CSV data from a URL (Kept for potential future use) ---
// ... (fetchCsvDataFromUrl function can remain here if needed for future, but won't be called by current get... functions)
